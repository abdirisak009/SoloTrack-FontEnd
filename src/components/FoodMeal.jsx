    ...
    return (
      <div className="p-6 bg-gray-50 min-h-screen">
            ...
            {[
              {
                ...
                image: "src/assets/FoodMeal/Lean Proteins.png",
              },
              {
        ...
        <div className="mt-10 bg-white shadow-md rounded-lg p-6">
          <h2 className="text-4xl font-bold text-center">Sample Meal Plan</h2>
